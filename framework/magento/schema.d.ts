...
export type Scalars = {
   ...
   *
   * Example value: `"https://johns-apparel.mymagento.com"`.
   *
   */
  URL: any
}
...
export type ApiVersion = {
  ...
  /** Whether the version is actively supported by Magento. Supported API versions are guaranteed to be stable. Unsupported API versions include unstable, release candidate, and end-of-life versions that are marked as unsupported. For more information, refer to [Versioning](https://magento.dev/concepts/about-apis/versioning). */
 ...
 * a Magento vaulted credit card payment.
 */
export type CreditCardPaymentInput = {
  /** The amount of the payment. */
  amount: Scalars['Money']
  /** A unique client generated key used to avoid duplicate charges. When a duplicate payment is found, the original is returned instead of creating a new one. For more information, refer to [Idempotent requests](https://magento.dev/concepts/about-apis/idempotent-requests). */
  idempotencyKey: Scalars['String']
  /** The billing address for the payment. */
  billingAddress: MailingAddressInput
  /** The ID returned by Magento's Card Vault. */
...
/** Represents a video hosted outside of Magento. */
...
export type Image = {
  ...
  /** The original height of the image in pixels. Returns `null` if the image is not hosted by Magento. */
  ...
  /** The original width of the image in pixels. Returns `null` if the image is not hosted by Magento. */
...
export enum MediaContentType {
  ...
  /** A Magento hosted image. */
  Image = 'IMAGE',
  /** A 3d model. */
  Model_3D = 'MODEL_3D',
  /** A Magento hosted video. */
  Video = 'VIDEO',
}
...
/** Represents a Magento hosted image. */
...
/** Represents a Magento hosted 3D model. */
...
/** Represents a source for a Magento hosted 3d model. */
...
export type Mutation = {
  ...
  /**
   * Completes a checkout using a credit card token from Magento's Vault.
  ...
  /** Completes a checkout using a credit card token from Magento's card vault. Before you can complete checkouts using CheckoutCompleteWithCreditCardV2, you need to  [_request payment processing_](https://help.magento.com/api/guides/sales-channel-sdk/getting-started#request-payment-processing). */
...
/** Magento merchants can create pages to hold static HTML content. Each Page object represents a custom page on the online store. */
...
export type Payment = Node & {
   ...
   * [Idempotent requests](https://magento.dev/concepts/about-apis/idempotent-requests).
   */
  ...
  /** The actual transaction recorded by Magento after having processed the payment with the gateway. */
...
export type PaymentSettings = {
  ...
  currencyCode: CurrencyCode
  /** A list of enabled currencies (ISO 4217 format) that the shop accepts. Merchants can enable currencies from their Magento Payments settings in the Magento admin. */
  enabledPresentmentCurrencies: Array<CurrencyCode>
  /** The shop’s Magento Payments account id. */
  magentoPaymentsAccountId?: Maybe<Scalars['String']>
...
/**
 * A product represents an individual item for sale in a Magento store. Products are often physical, but they don't have to be.
...
export type QueryRoot = {
   ...
   * [*Showing product recommendations on product pages*](https://help.magento.com/themes/development/recommended-products).
   */
 ...
 * was created by a Magento Script.
 */
...
/** Represents a Magento hosted video. */
...
/** Represents a source for a Magento hosted video. */
